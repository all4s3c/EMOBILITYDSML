 ...
 * <!-- end-user-doc -->
 * @see emobility.EmobilityPackage#getmOS_type()
 * @model
 * @generated
 */
public enum mOS_type implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final mOS_type[] VALUES_ARRAY =
		new mOS_type[] {
			ANDROID,
			IOS,
		};
	 ...
	 * @generated
	 */
	public static final List<mOS_type> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static mOS_type get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			mOS_type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static mOS_type getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			mOS_type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static mOS_type get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private mOS_type(int value, String name, String literal) {
		this.value = value;
		this.name = name;
