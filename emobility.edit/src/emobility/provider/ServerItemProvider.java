...
/**
 * This is the item provider adapter for a {@link emobility.Server} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServerItemProvider extends Energy_Transfer_ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_os_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_os_type_feature", "_UI_Server_type"),
				 EmobilityPackage.Literals.SERVER__OS_TYPE,
				 true,
				 false,
				 false,
